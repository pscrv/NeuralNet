...
namespace NeuralNet
{
    //public class NeuralFunction2 : INetComponent
    //{
    //    #region static
    ...
    //    public int NumberOfInputs { get { return _numberOfUnits; } }
    //    public int NumberOfOutputs { get { return _numberOfUnits; } }
    //    public NetworkVector Input { get { return _input; } protected set { _input = value; } }
    //    public NetworkVector Output { get { return _output; } protected set { _output = value; } }


    //    public void Run(NetworkVector inputvalues)
    //    {
    //        Input = inputvalues;
    ...
    //    #region Constructors
    //    public NeuralFunction2(int numberofunits)
    //    {
    ...
    //    public NeuralFunction2(int numberOfUnits, ActivationFunction activationfunction, DerivativeFunction derivativefunction, double[] biases = null)
    //        : this(numberOfUnits)
    //    {
